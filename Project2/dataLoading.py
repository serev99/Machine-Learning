...
imdb_train = datasets.load_files("C:/Academy/WINTER 2020/COMP551/Assignment2/IMDB_train", description=None, categories=None, load_content=True, shuffle=True, encoding='utf-8', decode_error='strict', random_state=0)
...
imdb_test = datasets.load_files("C:/Academy/WINTER 2020/COMP551/Assignment2/IMDB_test", description=None, categories=None, load_content=True, shuffle=True, encoding='utf-8', decode_error='strict', random_state=0)
